...
Class BlogTranslator extends Transition
{
    /**
    ...
    */
    ...
    public function __construct(int $projectId, TuringStrip $head, Collection $models)
    {
        ...
        $this->blogEntry = BlogArticle::where('project_id', $this->project->id)->latest()->first();
    }
    ...
    {
        $this->blogEntry->articleENraw = $data;
        return $data;
    }
    ...
    protected function postProcessPrompt($prompt)
    {
        ...
        // To avoid unpredictable behavior, it is recommended to maintain type integrity between input and outpUt, which the check below ensures.
    ...
    protected function postProcessOutput(string $data) : string
    {
        ...
        $data = json_encode([
                            ...
                            ["article" => $this->blogEntry->articleDEraw],
                            ["image" => $imgPrompt[1][0]]
                            ]);
